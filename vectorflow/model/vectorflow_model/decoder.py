...
from vectorflow.model.modules.decoder_modules import FinalLayer, PostFusion
from vectorflow.model.model_utils.tool_func import sinusoidal_positional_encoding
from vectorflow.model.modules.decoder_modules import RMSNorm, FeedForward, AdaptiveLayerNorm
from vectorflow.model.vectorflow_model.global_attention import JointAttention


class VectorFlowDecoder(nn.Module):
    def __init__(
            self,
            hidden_dim,
            depth,
    ...
    def forward(self, x, t, **model_extra):
        '''
        Forward pass of the VectorFlowDecoder.
...
class VectorFlowDiTBlock(nn.Module):
    def __init__(
        self,
        *,
...
class VectorFlowDiT(nn.Module):
    def __init__(
        ...
        **block_kwargs
        ...
        blocks = [VectorFlowDiTBlock(dim_modalities = dim_modalities, enable_attn_dist = enable_attn_dist, **block_kwargs) for _ in range(depth)]
